...
class StateSyncTests(unittest.TestCase):
                    ...
                    "projects": [
                        {
                            ...
                            "workspace_windows": r"C:\Users\test\Code\shared-project",
                        }
                    ],
                }
            ),
    ...
    def test_apply_is_additive_idempotent_and_remaps_projects(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(rows[SOURCE_THREAD]["cwd"], r"C:\Users\test\Code\shared-project\nested")
            ...
            self.assertEqual(assignment["path"], r"C:\Users\test\Code\shared-project")
